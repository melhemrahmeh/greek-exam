...
export const phraseSections: PhraseSection[] = [
  {
    ...
    items: [
      ...
      {
        gr: "Ένα νερό χωρίς ανθρακικό, παρακαλώ.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Χάθηκα. Μπορείτε να με βοηθήσετε;",
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Το σπίτι μου είναι κοντά στο κέντρο.",
        en: "My house is near the centre.",
      },
      {
        gr: "Καθαρίζω το σπίτι κάθε Σάββατο.",
        en: "I clean the house every Saturday.",
      },
      {
        gr: "Πλένω τα ρούχα το βράδυ.",
        en: "I wash the clothes in the evening.",
      },
      {
        gr: "Μαγειρεύω στο σπίτι σχεδόν κάθε μέρα.",
        en: "I cook at home almost every day.",
      },
      {
        gr: "Το δωμάτιό μου είναι μικρό αλλά άνετο.",
        en: "My room is small but comfortable.",
      },
      { gr: "Χρειάζομαι καινούριο ψυγείο.", en: "I need a new fridge." },
      { gr: "Ανοίξτε το παράθυρο, παρακαλώ.", en: "Open the window, please." },
      {
        gr: "Το πλυντήριο δεν δουλεύει.",
        en: "The washing machine is not working.",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Το κατάστημα κλείνει στις οκτώ.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Μένω στην Κύπρο εδώ και τρία χρόνια.",
        en: "I have been living in Cyprus for three years.",
      },
      ...
      {
        gr: "Μαθαίνω ελληνικά για την εξέταση.",
        en: "I am learning Greek for the exam.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        gr: "Στρίψτε δεξιά στο φανάρι.",
        en: "Turn right at the traffic light.",
      },
      { gr: "Στρίψτε αριστερά στη γωνία.", en: "Turn left at the corner." },
      {
        gr: "Είναι δίπλα στο σούπερ μάρκετ.",
        en: "It is next to the supermarket.",
      },
      {
        gr: "Είναι απέναντι από την εκκλησία.",
        en: "It is opposite the church.",
      },
      { gr: "Είναι κοντά ή μακριά;", en: "Is it near or far?" },
      {
        gr: "Παίρνω το πρώτο δρόμο δεξιά.",
        en: "I take the first road on the right.",
      },
      {
        gr: "Το νοσοκομείο είναι πίσω από το πάρκο.",
        en: "The hospital is behind the park.",
      },
      {
        gr: "Μπορείτε να μου δείξετε στον χάρτη;",
  ...
  },
  {
    ...
    items: [
      {
        gr: "Παρακαλώ;",
        en: "Hello? (answering phone)",
        note: "standard phone greeting",
      },
      { gr: "Ποιος είναι;", en: "Who is it?" },
      { gr: "Θέλω να κλείσω ραντεβού.", en: "I want to make an appointment." },
      {
        gr: "Για πότε θέλετε;",
        en: "For when do you want it?",
        note: "staff asks",
      },
      { gr: "Μπορείτε να με πάρετε αργότερα;", en: "Can you call me later?" },
      {
        gr: "Θα σας καλέσω ξανά αύριο.",
        en: "I will call you again tomorrow.",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Η δουλειά μου αρχίζει στις εννέα.",
        en: "My work starts at nine.",
      },
      ...
      {
        gr: "Πρέπει να τελειώσω αυτό σήμερα.",
      ...
      {
        gr: "Στέλνω ένα email στον συνάδελφό μου.",
        en: "I am sending an email to my colleague.",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Θέλεις να έρθεις στο πάρτι μου;",
        en: "Do you want to come to my party?",
      },
      ...
      {
        gr: "Ευχαριστώ για την πρόσκληση!",
  ...
  },
  {
    ...
    items: [
      ...
      {
        gr: "Ο δάσκαλος εξηγεί πολύ καλά.",
        en: "The teacher explains very well.",
      },
      {
        gr: "Κάνω μάθημα δύο φορές την εβδομάδα.",
        en: "I have a lesson twice a week.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        gr: "Ο καιρός είναι καλός, πάμε βόλτα!",
        en: "The weather is nice, let's go for a walk!",
      },
      { gr: "Το καλοκαίρι πάω στη θάλασσα.", en: "In summer I go to the sea." },
      {
        gr: "Τον χειμώνα χιονίζει στα βουνά.",
        en: "In winter it snows in the mountains.",
      },
      {
        gr: "Η άνοιξη είναι η αγαπημένη μου εποχή.",
